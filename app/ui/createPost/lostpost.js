...
import { addLostPost } from "../../actions/addLostPost";
...
const AddLostPostComponent = () => {
  ...
  const [lostDate, setFoundDate] = useState("");
  ...
  const doneAction = () => {
    ...
    window.location.href = "/lost-found-hub/myLostPostEdit";
  };
        ...
        <div>
          <div className="px-4 py-5 md:px-6 lg:p-5 bg-white w-full max-w-xl mx-auto rounded-xl">
            <div className="px-4 py-5 md:px-6 lg:p-5 bg-white w-full max-w-xl mx-auto">
              <h1 className="text-2xl font-bold text-center">Add Lost Post </h1>
